...
export const chatbotConfig = {
  ...
  //   1. Định danh nhân vật rõ
  //   2. Quy tắc tone & độ dài (2-3 câu, thân thiện)
  //   3. Anti-hallucination: phải nói KHÔNG BIẾT khi không biết
  //   4. Whitelist các ngành đào tạo - chặn câu trả lời sai về ngành
  //   5. Escalation path: chuyển sang Zalo OA khi cần người thật
  // ============================================================
...
"Rất vui được hỗ trợ bạn! 😊 Nếu cần thêm thông tin, bạn cứ nhắn mình hoặc Zalo OA 0375 711 766 nhé. Chúc bạn chọn được ngành học phù hợp!"`,
  ...
  model: {
    ...
    temperature: 0.7, // chút sáng tạo nhưng vẫn ổn định
    maxOutputTokens: 300, // giữ câu trả lời ngắn
  },
} as const;
