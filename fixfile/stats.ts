 ...
 *
 * Sai sót trên website cũ:
 *   - "20+ năm phát triển" (thực tế chỉ 15-16 năm tính từ 2010)
 *   - "98% sinh viên có việc làm ngay" (không nguồn)
 *   - "200+ đối tác" (thực tế chỉ thấy 1 logo)
 */
...
export const stats: Record<string, Stat> = {
  ...
  employmentRate: {
    ...
    icon: 'work',
    // Ví dụ khi có dữ liệu thật:
    // value: '85%',
    // source: 'Khảo sát SV tốt nghiệp khóa 2023, N=180 (6 tháng sau TN)',
  },
  ...
  qualityCert: {
    // ISO chỉ giữ khi trường THẬT SỰ có chứng nhận - cần kiểm tra
