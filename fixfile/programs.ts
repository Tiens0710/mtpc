 ...
 *
 * Mã ngành tham khảo từ Thông tư của Bộ LĐTBXH/Bộ Y tế - Hiệp xác minh lại
 * với phòng đào tạo trước khi public.
 */
...
export const programs: Program[] = [
  {
    ...
    image: '/images/programs/y-si.jpg',
  },
  {
    ...
    image: '/images/programs/duoc.jpg',
  },
  {
    slug: 'dieu-duong',
    code: '5720301',
    ...
    image: '/images/programs/dieu-duong.jpg',
  },
  {
    slug: 'ho-sinh',
    code: '5720303',
    ...
    image: '/images/programs/ho-sinh.jpg',
  },
  {
    ...
    image: '/images/programs/cntt-ai.jpg',
  },
];

// ============================================================
// CHƯƠNG TRÌNH SƠ CẤP (đào tạo ngắn hạn)
// Theo quy tắc trường: 1 giờ LT = 2 giờ TH
// Mặc định: 90 giờ LT + 480 giờ TH = 570 tổng giờ
// ============================================================
export const shortCoursePrograms: Program[] = [
  {
    ...
    image: '/images/programs/sua-chua-may-tinh.jpg',
  },
];
